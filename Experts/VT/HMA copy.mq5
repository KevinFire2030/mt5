...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   int handle_hma = iMA(_Symbol, PERIOD_CURRENT, (int)MathSqrt(InpPeriod), 0, MODE_LWMA, InpPrice);
   
   if(handle_wma1 == INVALID_HANDLE || handle_wma2 == INVALID_HANDLE || handle_hma == INVALID_HANDLE)
     {
      Print("지표 핸들 생성 실패");
      return(0);
     }
